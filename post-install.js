...
function runScript(currentLocale, dev) {
  ...
  if (currentLocale == 'sv') {
    ...
    exec(
      'cp -f ./src/app/config/routes-config-sv.ts ./src/app/config/routes-config.ts '
    );
    exec(
      'cp -f ./src/app/shared/constants/mask-sv.ts ./src/app/shared/constants/mask.ts '
    );
    exec(
      'cp -f ./src/app/local-components/components-sv.ts ./src/app/local-components/components-output.ts '
    );
    ...
    locale = ',nb';
    exec(
      'cp -f ./src/app/config/routes-config-no.ts ./src/app/config/routes-config.ts '
    );
    exec(
      'cp -f ./src/app/shared/constants/mask-no.ts ./src/app/shared/constants/mask.ts '
    );
    exec(
      'cp -f ./src/app/local-components/components-no.ts ./src/app/local-components/components-output.ts '
    );
