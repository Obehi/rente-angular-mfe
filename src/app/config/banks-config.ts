const BANKS_DATA_NO = {
  ...
  SEB: {
    ...
    imgCircle: '../../assets/img/banks-logo/round/skandinaviske_enskilda.png'
  },
  SELBU_SB: {
    name: 'SELBU_SB',
    img: '',
  ...
  SPAREBANK_1_SOROST_NORGE: {
    name: 'SPAREBANK_1_SOROST_NORGE',
    img: '../../assets/img/banks-logo/square/sparebank1v2.png',
    imgCircle: '../../assets/img/banks-logo/round/sparebanken1v2.png'
  },
  ...
  SB_SOGNFJORDANE: {
    ...
    imgCircle: '../../assets/img/banks-logo/round/sogn_og_fjordane.png'
  },
  SB_SOR: {
    name: 'SB_SOR',
    img: '',
