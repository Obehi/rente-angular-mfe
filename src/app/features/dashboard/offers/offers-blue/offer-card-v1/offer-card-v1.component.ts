...
@Component({
  selector: 'rente-offer-card-v1',
  templateUrl: './offer-card-v1.component.html',
  styleUrls: ['./offer-card-v1.component.scss']
})
export class OfferCardV1Component implements OnInit {
