...
export class LoggingService {
  ...
  public logger(level: number, category: string, className: string, methodName: string, subSystem: string, msg?: string, object?: object) {
    ...
    var tag = environment['name'] === undefined || null ? category : environment['name'] + "_" + category
    var logg = {
    ...
    this.http.postExternal(this.apiUrl, logg).pipe(first()).subscribe( res => {
   });
