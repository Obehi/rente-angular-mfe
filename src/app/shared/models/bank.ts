...
export const BankList:BankVo[] = [
  ...
  new BankVo('BLAKER_SB', 'Blaker Sparebank', 'EikaNewGreenThree.png', null, true),
  new BankVo('DRANGEDAL_SB', 'Drangedal Sparebank', 'OldEika.png', null, true),
  ...
  new BankVo('EVJE_SB', 'Evje og Hornnes Sparebank', 'EikaNewGreenThree.png', null, true),
  ...
  new BankVo('HOLAND_SB', 'Høland og Setskog Sparebank', 'holandSetskog.png', null, true),
  new BankVo('HONEFOSS_SB', 'Hønefoss Sparebank', 'EikaNewGreenThree.png', null, true),
  ...
  new BankVo('SPAREBANKEN_DIN', 'Sparebanken DIN', 'SparebankenDin.png', null, true),
  new BankVo('SB_NARVIK', 'Sparebanken Narvik', 'SparebankenNarvik.png', null, true),
  ...
  new BankVo('OSTRE_AGDER_SB', 'Østre Agder Sparebank', 'ostreAgder.png', null, true),
